...
const image = '/img/blog/8-magnetostatic2Bodies.png'
  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          We consider <MathJax.Inline text={String.raw`\Omega^{1}`} /> and{' '}
          <MathJax.Inline text={String.raw`\Omega^{2}`} /> two domains of{' '}
          <MathJax.Inline text={String.raw`\mathbb{R}^{2}`} />. We suppose that{' '}
          <MathJax.Inline text={String.raw`\Omega^{1}`} /> and{' '}
          <MathJax.Inline text={String.raw`\Omega^{2}`} /> have a common
          interface called <MathJax.Inline text={String.raw`\Gamma_{c}`} />.
        </p>

        <p>
          The domain <MathJax.Inline text={String.raw`\Omega^{i}`} />, with{' '}
          <MathJax.Inline text={'i= 1,2'} />, is bounded by{' '}
          <MathJax.Inline
            text={String.raw`\partial \Omega^{i} = \Gamma_d^{i} \cup\Gamma_n^{i} \cup \Gamma_{c}`}
          />
          .
        </p>
        ...
        <p>
          ...
          in <MathJax.Inline text={String.raw`\Omega^{i}`} />, verifying{' '}
          <MathJax.Inline text={String.raw`B^{i} = \nabla \times A^{i}`} />,
          where <MathJax.Inline text={'B^{i}'} /> is the magnetic flux density
          in <MathJax.Inline text={String.raw`\Omega^{i}`} />.
        </p>
...
`}
          />
          where <MathJax.Inline text={String.raw`\mu_{i}`} /> is the magnetic
          permeability of <MathJax.Inline text={String.raw`\Omega^{i}`} />,{' '}
          <MathJax.Inline text={'j^{i}'} /> the current density,{' '}
          <MathJax.Inline text={'n^{i}'} /> the outward unit normal vector on
          the boundary <MathJax.Inline text={String.raw`\partial \Omega^{i}`} />
          , and <MathJax.Inline text={String.raw`\nabla \cdot A^{i} = 0`} /> the
          Coulomb gauge.
        </p>

        <p>
          In addition, we have the interface conditions governing the contact
          area <MathJax.Inline text={String.raw`\Gamma_{c}`} />, which are
